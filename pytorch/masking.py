...
def genMasks(H):
    ...
    mask_cv_final = np.zeros((H.shape[1], num_nodes))
    ...
    #the v-nodes are ordered & collated (huh?)
    ...
    return mask_cv, mask_vc, mask_cv_final, llr_expander
